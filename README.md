...
This README-file contains the coding in R to provide the plots from Martin Scharling's bachelor thesis in math-econ 2020. To download R-file look in this repository.
